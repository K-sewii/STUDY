...
int main(){
    ...
    while(tc--){
        ...
        for(int i = v.size()-1; i >= 0; i--){// cout ra o ngoai vong lap while, neu ma in trong vong while thi no chua thanh dc hinh xoan oc da in ra thi ko dung yeu cau minh dang can
                cout << v[i] << " ";
        }
    }
    return 0;
